                    ...
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/student/update.do" method="post"
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="name" hidden="hidden">id</label>

                                <div class="col-sm-9">
                                    <input type="text" id="id" name="id" required="required" class="col-xs-10 col-sm-5"
                                           maxlength="20" readonly="readonly" hidden="hidden"
                            ...
                            <input type="hidden" name="totalTotalPrice"
                                   value="${studentOperateVo.studentVo.totalTotalPrice}"/>

                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="paidMoney">付款金额</label>

                                <div class="col-sm-9">
                                    <input type="text" id="paidMoney" name="paidMoney" required="required" class="col-xs-10 col-sm-5"
                                           maxlength="20"
                                           value="${studentOperateVo.studentVo.totalTotalPrice}"/>
                                </div>
                            </div>
